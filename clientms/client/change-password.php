...
$sql ="SELECT EmployeeID FROM tblemployee WHERE EmployeeID=:employeeId and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblemployee set Password=:newpassword where EmployeeID=:employeeId";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':employeeId', $employeeId, PDO::PARAM_STR);
