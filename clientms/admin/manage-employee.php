			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Manage Employees </h3>
						<div class="graph">
							<div class="tables">
...
{               ?>
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									         ...
									         <td><?php  echo htmlentities($row->EmployeePhnumber);?></td>
									        <td><a href="edit-employee-details.php?eid=<?php echo $row->EmployeeID;?>">Edit</a> 
									     </tr>
									     <?php $cnt=$cnt+1;}} ?>
									     </tbody> </table> 
							</div>
