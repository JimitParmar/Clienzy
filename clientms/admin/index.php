...
if(isset($_POST['login'])) 
  {	
	...
	$_SESSION['adminmsname'] = $adminname;
    $sql ="SELECT ID FROM tbladmin WHERE AdminName=:adminname and Password=:password";
		...
		<div class="error-top">
			...
			<div class="login">
				...
				<div class="buttons login">
					<h3 class="inner-tittle t-inner" style="color: lightblue">Admin Login</h3>
				</div>
				<form id="login" method="post" name="login"> 
					<input type="text" class="text" value="User Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'AdminName';}" name="adminname" required="true">
